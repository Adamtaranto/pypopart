...
class GeoVisualizer:
    ...
    def plot(
        ...
        **kwargs,
        ...
        layout = geo_layout.compute(coordinates=coordinates, projection=projection)
        
        # Convert layout positions back to lat/lon for plotting
        # (since cartopy handles projection)
