...
class Alignment:
    ...
    def validate(self) -> None:
        ...
        if not self.is_valid():
            ...
            raise ValueError(f"Alignment invalid: sequences have different lengths {set(lengths)}")
    ...
    def _hamming_distance(self, seq1: Sequence, seq2: Sequence) -> int:
        ...
        return sum(c1 != c2 for c1, c2 in zip(seq1.data, seq2.data) if c1 != '-' and c2 != '-')
    ...
    def __str__(self) -> str:
        ...
        return (f"Alignment: {stats.num_sequences} sequences, "
