...
from pypopart.core.alignment import Alignment, AlignmentStats
...
class TestAlignment:
    ...
    def test_slice_alignment(self):
        ...
        sequences = [
            Sequence("seq1", "ATCGAA"),
            Sequence("seq2", "GTCCGG")
        ]
        alignment = Alignment(sequences)
    ...
    def test_calculate_stats(self):
        ...
        assert stats.parsimony_informative_sites == 0  # No position has ≥2 chars appearing ≥2 times
